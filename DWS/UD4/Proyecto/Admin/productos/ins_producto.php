<?php
    ...
    include("../db/db.inc"); // Asegúrate de que $conn es tu conexión MySQLi

    if(isset($_POST["nombre"]) && !empty($_POST["nombre"])) {
        
        // 1. Recogida y saneamiento básico para SQL (mysqli_real_escape_string es vital aquí)
        $nombre = mysqli_real_escape_string($conn, $_POST["nombre"]);
        $descripcion = mysqli_real_escape_string($conn, $_POST["descripcion"]);
        
        // Valores numéricos forzados a su tipo
        ...
        {
            // Debug: echo mysqli_error($conn); die();
    ...
    <main class="container mt-5">
        <div class="card shadow">
            <div class="card-header bg-success text-white">
                <h2 class="h4 mb-0">📦 Alta de Producto (MySQLi)</h2>
            </div>
            <div class="card-body">
                <form method="POST">
                    <div class="row g-3">
