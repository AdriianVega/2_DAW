...
<body class="p-3">
    <?php
        ...
        {
            echo "<div class='alert alert-success' role='alert'> ✅ La sesión ha sido cerrada con éxito </div>";
        }
        // Mostramos un mensaje de bienvenida personalizado o no según si existe la sesión con nombre de usuario
    ...
    ?>
    <form action="result_form_sesiones.php" method="post" class="mb-4">
    ...
    <?php
        // Comprobamos si existe la sesión con el nombre del usuario
        if (isset($_SESSION["name"]))
        {
            echo '<p><a href="ej8_borrar_sesion.php">Desconectar</a></p>';
        }
    ?>
